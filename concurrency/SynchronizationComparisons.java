...
package concurrency; /* Added by Eclipse.py */  //Bad code -> ArrayIndexOutOfBoundsException so i changed size of preloaded array
...
abstract class Accumulator {
  ...
  protected static int[] preLoaded = new int[SIZE * 30];
  static {
